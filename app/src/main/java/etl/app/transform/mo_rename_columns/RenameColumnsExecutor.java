package etl.app.transform.mo_rename_columns;
...
import etl.app.transform.mo_rename_columns.params.RenameColumnModel;
import etl.app.transform.mo_rename_columns.params.RenameColumnsParamsExtractor;
